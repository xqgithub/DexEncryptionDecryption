...
//                + " " + classesJar.getAbsolutePath());
        ...
        String dex = "E:/work/android-sdk-windows/build-tools/27.0.3/";
...
//        Process process = Runtime.getRuntime().exec(" zipalign -v -p  4 " + unSignedApk.getAbsolutePath()
        ...
        String dex = "E:/work/android-sdk-windows/build-tools/27.0.3/";
        String text = "cmd /c" + dex + "zipalign -f 4 " + unSignedApk.getAbsolutePath() + " " + alignedApk.getAbsolutePath();
        Process process = Runtime.getRuntime().exec(text);
        process.waitFor();
        ...
        System.out.println(process.waitFor() == 0 ? "zipalign---success" : "zipalign---failure");
    }
...
//                + signedApk.getAbsolutePath() + " " + alignedApk.getAbsolutePath());
        ...
        String dex = "E:/work/android-sdk-windows/build-tools/27.0.3/";
        String text = "cmd /c" + dex + "apksigner sign --ks " + jks.getAbsolutePath() + " --ks-key-alias yangkun --ks-pass pass:123123 --key-pass pass:123123 --out " + signedApk.getAbsolutePath() + " " + alignedApk.getAbsolutePath();
        Process process = Runtime.getRuntime().exec(text);
